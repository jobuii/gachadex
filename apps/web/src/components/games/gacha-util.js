...
// cyan · green · violet · gold. Each component keeps its own tiny lookup wrapper (their fallbacks differ).
export const RARITY_COLORS = { common: '#22D3EE', uncommon: '#22c55e', rare: '#a855f7', epic: '#ffc93c' };
...
// Single reduced-motion check shared by the reveal's motion layers (FX particles, ambient, card tilt) so they
// all honour the OS setting the same way. Wrapped in try/catch for SSR / matchMedia-less environments.
